...
class CafeListAdapter(private var cafeList : ArrayList<CafeListResponseModel>) :RecyclerView.Adapter<CafeListAdapter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CafeListAdapter.ViewHolder {

val view = LayoutInflater.from(parent.context).inflate(R.layout.rv_item_cafe_list,parent,false)
